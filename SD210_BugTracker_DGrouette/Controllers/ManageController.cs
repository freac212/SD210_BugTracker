...
namespace SD210_BugTracker_DGrouette.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult ChangeDisplayName()
        {
            ...
            {
                DisplayName = UserManager.FindById(User.Identity.GetUserId()).DisplayName
            };
            // Get current user, 
            // Send current display name to view
        ...
        public ActionResult ChangeDisplayName(ChangeDisplayNameViewModel model)
        {
            ...
            if(user == null)
            {
                return RedirectToAction("Index", new { Message = "Error in changing name." });
            } else
            {
                // Display name
            ...
            return RedirectToAction("Index", new { Message = "Display name changed."});
        }
